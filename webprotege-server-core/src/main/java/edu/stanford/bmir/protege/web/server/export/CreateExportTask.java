 ...
 * 14 Apr 2017
 */
public class CreateExportTask implements Callable<Void> {

    private static final Logger logger = LoggerFactory.getLogger(CreateExportTask.class);
    ...
    @AutoFactory
    public CreateExportTask(@Provided @Nonnull ProjectManager projectManager,
                            ...
                            @Provided @Nonnull ProjectExporterFactory projectExporterFactory) {
        ...
        this.projectExporterFactory = projectExporterFactory;
    }
    ...
    public Void call() throws Exception {
        ...
        try (BufferedOutputStream outputStream = new BufferedOutputStream(Files.newOutputStream(downloadPath))) {
            exporter.exportProject(outputStream);
        }
