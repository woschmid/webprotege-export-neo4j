...
public enum ExportFormat {
    ...
    RDF_XML(RDFXMLDocumentFormat::new, "application/rdf+xml", ExportFormatExtension.owl),

    RDF_TURLE(TurtleDocumentFormat::new, "text/turtle", ExportFormatExtension.ttl);
/*
...
*/
    ...
    private final ExportFormatExtension extension;

    ExportFormat(Supplier<OWLDocumentFormat> documentFormatSupplier, String mimeType, ExportFormatExtension extension) {
     ...
     * Not {@code null}.
     */
    public static ExportFormat getExportFormatFromParameterName(String parameterName) {
     ...
     */
    public static ExportFormat getDefaultFormat() {
        return RDF_XML;
    }
}
